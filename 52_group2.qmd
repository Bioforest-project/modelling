...
read_tsv("outputs/parameters.tsv") %>% 
  ...
  scale_color_discrete("") +
  theme(legend.position = "bottom") +
  xlab(expression(Climate~Water~Deficit~"["~mm~year^{-1}~"]"))
```
...
read_tsv("outputs/parameters.tsv") %>% 
  ...
  scale_color_discrete("") +
  theme(legend.position = "bottom") +
  xlab(expression(Bulk~Density~"["~kg~dm^{-3}~"]"))
```
...
read_tsv("outputs/parameters.tsv") %>% 
  ...
  scale_color_discrete("") +
  theme(legend.position = "bottom") +
  xlab(expression(Soil~organic~Carbon~"["~g~kg^{-1}~"]"))
```
