...
```{r fit_all}
#| eval: false
# ltp <- cmdstan_model("models/ltp.stan") #nolint
stp <- cmdstan_model("models/stp.stan")
# vars <- c( #nolint
#   "nstem", "agb", "WD_cwm_ba", "FDiv", "diversity_q1_gen", "gini", #nolint
#   "ba", "FEve", "SLA_cwm_ba", "N_cwm_ba", "hmax_cwm_ba" #nolint
# ) #nolint
vars <- "FDiv"
# for (var in vars) { #nolint
#   sample_model(var, "ltp") #nolint
# } #nolint
for (var in vars) {
