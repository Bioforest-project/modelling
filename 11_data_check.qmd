...
spurious_data_str <- read_csv("data/raw_data/aggregated_data.csv") %>%
  rename_all(tolower) %>%
  rename(site_raw = site) %>%
  left_join(read_tsv("data/raw_data/sites.tsv")) %>%
  select(-site_raw) %>%
...
spurious_data_div <- read_csv("data/raw_data/aggregated_data.csv") %>%
  rename_all(tolower) %>%
  rename(site_raw = site) %>%
  left_join(read_tsv("data/raw_data/sites.tsv")) %>%
  select(-site_raw) %>%
...
spurious_data_func <- read_csv("data/raw_data/aggregated_data.csv") %>%
  rename_all(tolower) %>%
  rename(site_raw = site) %>%
  left_join(read_tsv("data/raw_data/sites.tsv")) %>%
  select(-site_raw) %>%
