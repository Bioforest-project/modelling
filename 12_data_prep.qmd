...
sites <- c(
  "Antimary APU2", "Antimary APU3", "BAFOG", "Corinto", "Ecosilva", "Gola", "Iracema", "Iwokrama", "Jari", "Jenaro Herrera", "Kabo", "Kibale", "Lesong", "Malinau", "Manare", "Mbaiki", "Mil", "Misiones", "Moju", "Montagne Tortue", "Nelliyampathy", "Pad Limo 2 Barracos", "Pad Limo Chico Bocao", "Pad Limo Cumaru", "Pad Limo Jatoba", "Pad Limo Pocao", "Pad Limo STCP", "Paracou", "Peixoto", "Peteco", "Sao Nicolau", "Ser Filipinas", "Sungai Lalang", "Tapajos Km114", "Tapajos Km67", "Tirimbina", "Ulu Muda", "Uppangala"
)
antimary_sites <- c(
  "Antimary APU2", "Antimary APU3"
)
pad_sites <- c(
  "Pad Limo 2 Barracos", "Pad Limo Chico Bocao", "Pad Limo Cumaru", "Pad Limo Jatoba", "Pad Limo Pocao", "Pad Limo STCP"
)
data <- read_csv("data/raw_data/aggregated_data_v5.csv") %>%
  na.omit() %>% 
  rename_all(tolower) %>%
  rename(site_raw = site) %>%
