...
Old growth forest model using control and pre-logging inventories to inform $\theta$ prior of the recovery trajectory:
...
Long term and short term processes model:
